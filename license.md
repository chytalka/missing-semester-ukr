...
You can submit corrections and suggestions to the course material by submitting issues and pull requests on our GitHub [repo](https://github.com/chytalka/missing-semester-ukr). This includes the captions for the video lectures which are also in the repo (see [here](https://github.com/chytalka/missing-semester-ukr/tree/main/static/files/subtitles/2020)).
